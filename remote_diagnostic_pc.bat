...
:: 서버 엔드포인트는 아래 $serverUrl 을 환경에 맞게 수정하세요.
...
echo Write-Host "Result saved: $dst" >> "%temp%\pc_finalize.ps1"
...
echo     Write-Host "Sent to $serverUrl. HTTP $^($response.StatusCode^)" >> "%temp%\pc_finalize.ps1"
